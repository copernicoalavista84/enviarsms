...
$remitente = @$_POST['emisor']; //nombre o numero de quien envia el SMS
$mensaje = @$_POST['mensaje'];//mensaje a enviar
$destinatario = @$_POST['telefono'];; //numeros de celular separados por (,)
...
for($i=0;$i<count($destinatarioArray);$i++){
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, "codapi=" . $codapi . "&remitente=" . $remitente . "&mensaje=" . $mensaje . "&destinatario=" . $destinatarioArray[$i] .
